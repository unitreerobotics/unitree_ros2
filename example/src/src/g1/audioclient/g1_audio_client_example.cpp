/**
 * This example demonstrates how to use ROS2 to call audio client api of unitree g1 robot
 **/
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        /*TTS Example*/
        int32_t ret = client->TtsMaker("你好。我是宇树科技的机器人G1。例程启动成功", 0);
        ...
        {
            ret = client->PlayStream("example", std::to_string(unitree::common::GetCurrentTimeMilliseconds()), pcm);
